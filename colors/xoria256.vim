...
" -------------------------------------------
"
" edited by Bartłomiej Danek <bartek.danek@gmail.com>
" https://github.com/bartekd/xoria256.vim
"
"
" Initialization {{{
...
hi  Error            ctermfg=161  guifg=#df005f ctermbg=bg         guibg=bg
hi  ErrorMsg         ctermfg=161  guifg=#df005f ctermbg=bg         guibg=bg
...
hi  Typedef          ctermfg=146  guifg=#afafdf cterm=none         gui=none
hi  Keyword          ctermfg=68   guifg=#5f87df cterm=bold         gui=bold
